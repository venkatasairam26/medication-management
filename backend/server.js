...
app.get("/api/medication", authenticateToken, async (request, response) => {
...
app.post("/api/medication", authenticateToken, async (request, response) => {
...
app.put("/api/medication/:id", authenticateToken, async (request, response) => {
...
app.delete("/api/medication/:id", authenticateToken, async (request, response) => {
